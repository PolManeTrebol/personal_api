...
from src.v1.keycloak_mails_account.keycloak_mails_group_view import api as keycloak_mails_group_api
...
api.add_namespace(keycloak_mails_group_api, path='/keycloak_mails')
