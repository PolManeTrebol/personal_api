...
class GroupsByAccountExtractor:
    ...
    def extract_groups_with_idaccount(self, clients_group: dict[str, type], idaccount: int) -> list[str]:
        groups_ids = []
    ...
    def _recurse_subgroups(self, group: dict[str, type], id_account) -> list[str]:
        groups_ids = []
